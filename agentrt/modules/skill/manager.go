...
import (
	...
	"github.com/spharx/agentrt/sdk/go/agentrt/utils"
)
...
func (sm *SkillManager) Load(ctx context.Context, skillID string) (*types.Skill, error) {
	if skillID == "" {
		return nil, agentrt.NewError(agentrt.CodeMissingParameter, "技能ID不能为空", nil)
	}
	...
	if !ok {
		return nil, agentrt.NewError(agentrt.CodeInvalidResponse, "技能加载响应格式异常", nil)
	}
...
func (sm *SkillManager) Get(ctx context.Context, skillID string) (*types.Skill, error) {
	...
	data, ok := utils.ExtractDataMap(resp)
	if !ok {
		return nil, agentrt.NewError(agentrt.CodeInvalidResponse, "技能详情响应格式异常", nil)
	}
...
func (sm *SkillManager) Unload(ctx context.Context, skillID string) error {
	if skillID == "" {
		return agentrt.NewError(agentrt.CodeMissingParameter, "技能ID不能为空", nil)
	}
...
func (sm *SkillManager) Register(ctx context.Context, name string, description string, parameters map[string]interface{}) (*types.Skill, error) {
	if name == "" {
		return nil, agentrt.NewError(agentrt.CodeMissingParameter, "技能名称不能为空", nil)
	}
	...
	data, ok := utils.ExtractDataMap(resp)
	if !ok {
		return nil, agentrt.NewError(agentrt.CodeInvalidResponse, "技能注册响应格式异常", nil)
	}
...
func (sm *SkillManager) Update(ctx context.Context, skillID string, description string, parameters map[string]interface{}) (*types.Skill, error) {
	...
	data, ok := utils.ExtractDataMap(resp)
	if !ok {
		return nil, agentrt.NewError(agentrt.CodeInvalidResponse, "技能更新响应格式异常", nil)
	}
...
func (sm *SkillManager) GetInfo(ctx context.Context, skillID string) (*types.SkillInfo, error) {
	...
	data, ok := utils.ExtractDataMap(resp)
	if !ok {
		return nil, agentrt.NewError(agentrt.CodeInvalidResponse, "技能信息响应格式异常", nil)
	}
...
func (sm *SkillManager) Validate(ctx context.Context, skillID string, parameters map[string]interface{}) (bool, []string, error) {
	if skillID == "" {
		return false, nil, agentrt.NewError(agentrt.CodeMissingParameter, "技能ID不能为空", nil)
	}
	...
	data, ok := utils.ExtractDataMap(resp)
	if !ok {
		return false, nil, agentrt.NewError(agentrt.CodeInvalidResponse, "技能验证响应格式异常", nil)
	}
...
func (sm *SkillManager) Search(ctx context.Context, query string, topK int) ([]types.Skill, error) {
	if query == "" {
		return nil, agentrt.NewError(agentrt.CodeMissingParameter, "搜索查询不能为空", nil)
	}
	if topK <= 0 {
		topK = 10
	}
...
func parseSkillList(resp *types.APIResponse) ([]types.Skill, error) {
	data, ok := utils.ExtractDataMap(resp)
	if !ok {
		return nil, agentrt.NewError(agentrt.CodeInvalidResponse, "技能列表响应格式异常", nil)
	}
...
func parseSkillResult(resp *types.APIResponse) (*types.SkillResult, error) {
	data, ok := utils.ExtractDataMap(resp)
	if !ok {
		return nil, agentrt.NewError(agentrt.CodeInvalidResponse, "技能执行响应格式异常", nil)
	}
