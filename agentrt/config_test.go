...
func TestNewConfigFromEnv(t *testing.T) {
	os.Setenv("AGENTRT_ENDPOINT", "http://env:9999")
	os.Setenv("AGENTRT_TIMEOUT", "45s")
	os.Setenv("AGENTRT_MAX_RETRIES", "5")
	os.Setenv("AGENTRT_API_KEY", "env-key")
	os.Setenv("AGENTRT_DEBUG", "true")
	os.Setenv("AGENTRT_LOG_LEVEL", "debug")
	defer func() {
		os.Unsetenv("AGENTRT_ENDPOINT")
		os.Unsetenv("AGENTRT_TIMEOUT")
		os.Unsetenv("AGENTRT_MAX_RETRIES")
		os.Unsetenv("AGENTRT_API_KEY")
		os.Unsetenv("AGENTRT_DEBUG")
		os.Unsetenv("AGENTRT_LOG_LEVEL")
	}()
